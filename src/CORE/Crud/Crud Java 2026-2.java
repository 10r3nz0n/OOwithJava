    ...
    void main() {
        ...
        do {
            ...
            switch (opcao) { // switch case com -> , que não precisa break
                ...
                case 1 -> {
                    listarPessoas(arranjo);
                }
                case 2 -> {
                    inserirPessoa(arranjo);
                }
                case 3 -> {
                }
                case 4 -> {
                    excluirPessoa(arranjo);
                }
                case 5 -> {
                }
 ...
 * - Fazer funcao para mostrar as pessoas cadastradas em ordem alfabética
 * crescente de nome;
 * - Alterar o CRUD para suportar um novo atributo em Pessoa: salário;
 * - Fazer função para alterar o salário de uma Pessoa em determinado
 * percentual;
 * - Fazer função para alterar o salário de todas as Pessoas cadastradas em
 * determinado percentual;
 * - Fazer a funcao de editar os dados de uma pessoa pelo seu id, idade, nome,
 * salario ou ambos;
 * 
