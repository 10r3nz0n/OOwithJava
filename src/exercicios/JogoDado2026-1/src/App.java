import utilitarios.*; //utilização de pacote e classe
...
public class App {
    public static void main(String[] args) {
        ...
        Video.exibirCabecalho("Jogo de dado entre 2 jogadores!");

        Jogador j1 = new Jogador(Teclado.string("Informe o nome do Jogador 1: "));
        Jogador j2 = new Jogador(Teclado.string("Informe o nome do Jogador 2: "));

        if (j1.nome.equals(j2.nome)) {
            Video.println("Ajustando jogadores com nomes iguais...");
            j1.nome = j1.nome + " 1";
            j2.nome = j2.nome + " 2";
        }

        Dado dado = new Dado(Teclado.integer("Quantos lados tem o dado?"));
